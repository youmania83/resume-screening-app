      ...
      <aside className="w-[220px] flex-shrink-0 bg-card border-r border-border flex flex-col justify-between z-20 select-none">
        <div>
          <div className="h-14 flex items-center px-4.5 border-b border-border gap-2.5">
            ...
            <div>
              <span className="font-bold text-sm tracking-tight text-foreground bg-clip-text text-transparent bg-gradient-to-r from-foreground via-indigo-900 to-indigo-700 dark:from-foreground dark:to-indigo-300">Techsol Engineers</span>
